...
const webBridge = {
  ...
  createProject: (data: CreateProjectFileProps): Promise<IProjectServiceResponse> => invoke('project:create', data),
  ...
  openProject: (): Promise<IProjectServiceResponse> => invoke('project:open'),
